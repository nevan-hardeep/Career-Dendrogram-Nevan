...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO student_data(u_card, u_f_name, u_l_name, u_father, u_aadhar, u_birthday, u_gender, u_email, u_phone, u_state, u_dist, u_village, u_pincode, u_mother, u_family,image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_aadhar','$u_birthday','$u_gender','$u_email','$u_phone','$u_state','$u_dist','$u_village','$u_pincode','$u_mother','$u_family','$image',NOW())";
...
<head>
	...
	<h1>STUDENT PORTAL-EDUCATION MEETS TECHNOLOGY</h1>
	<meta charset="utf-8">
...
<label for="inputState">Insterests</label>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<i class='fa fa-home' aria-hidden='true'> Address : </i> $village, <br> $dist,  $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
